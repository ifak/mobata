...
int Settings::readNodeSettingsFromConfigFile(const QString categoryName)
{
  ...
  else
  {
    ...
    {
      incompleteSubItemCount+=(readColorSettingFromConfigFile<view::graph::NodeOptions>(nodeOptions, &view::graph::NodeOptions::setTextColor));
      incompleteSubItemCount+=(readFontSettingFromConfigFile<view::graph::NodeOptions>(nodeOptions, &view::graph::NodeOptions::setTextFont));
    }
    _configs->endGroup();
    ...
    {
      incompleteSubItemCount+=(readColorSettingFromConfigFile<view::graph::NodeOptions>(nodeOptions, &view::graph::NodeOptions::setColor));
      incompleteSubItemCount+=(readSizeSettingFromConfigFile<view::graph::NodeOptions>(nodeOptions, &view::graph::NodeOptions::setSize));
    }
    _configs->endGroup();
    ...
    {
      incompleteSubItemCount+=(readPenSettingFromConfigFile<view::graph::NodeOptions>(nodeOptions, &view::graph::NodeOptions::setPen));
    }
    _configs->endGroup();
...
QStandardItem* Settings::exportNodeProperties(const QString categoryName) const
{
  ...
  itemConfigList.append(exportSizeProperty<view::graph::NodeOptions>(QString("Box Size"),
                                                                     nodeOptions,
                                                                     &view::graph::NodeOptions::size));
  itemConfigList.append(exportColorProperty<view::graph::NodeOptions>(QString("Box Color"),
                                                                      nodeOptions,
                                                                      &view::graph::NodeOptions::getColor));

  QList<QList<QStandardItem*> > nodeBorderPenConfigList(exportPenProperty<view::graph::NodeOptions>(QString("Border"),
                                                                                                    nodeOptions,
                                                                                                    &view::graph::NodeOptions::pen));
  foreach (const QList<QStandardItem*> currProperty,
           nodeBorderPenConfigList)
