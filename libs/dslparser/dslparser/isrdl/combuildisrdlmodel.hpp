...
class DSLPARSERSHARED_EXPORT ComBuildIsrdlModel
    : public QObject
{
public:
  ComBuildIsrdlModel(const QString& isrdlDocText,
                      model::isrdl::IsrdlModel* isrdlModel,
                      bool strictErrorHandling = true,
                      QObject* parent =0);
  virtual ~ComBuildIsrdlModel();
...
private:
  Q_DISABLE_COPY(ComBuildIsrdlModel)
  class Private;
  Private* _d;
};
