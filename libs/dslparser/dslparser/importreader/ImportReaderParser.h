...
// Generated from C:/Users/j05kraus/Private/SWDevelop/mobata_oss_dev/libs/dslparser/dslparser/grammars/ImportReader.g4 by ANTLR 4.7.2
...
class  ImportReaderParser : public antlr4::Parser {
public:
  enum {
  ...
  enum {
    RuleImportReader = 0, RuleComponentIdPath = 1, RuleSignalIdPath = 2, 
    RuleAttributeIdPath = 3, RuleSignalSend = 4, RuleCommonDecl = 5, RuleImportPathDecl = 6, 
    RuleImportPathBody = 7, RuleImportFileBody = 8, RuleImportAs = 9, RuleTypeDefDecl = 10, 
    RuleTypeDecl = 11, RuleIntTypeDecl = 12, RuleRealTypeDecl = 13, RuleEnumTypeDecl = 14, 
    RuleAttributeDecl = 15, RuleLiteralValue = 16, RuleSignalParamName = 17, 
    RuleAttributeName = 18, RuleToPortName = 19, RuleAttributeAssignStatement = 20, 
    RuleLocalAssignStatement = 21, RuleSendToStatement = 22, RuleSingleAssignment = 23, 
    RuleMultiAssignment = 24, RuleSignalDecl = 25, RuleParamDecl = 26, RuleFunctionDecl = 27, 
    RuleFunctionParameters = 28, RuleFunctionCall = 29, RuleFunctionCallBody = 30, 
    RuleFunctionCallBodyOptional = 31, RuleContextID = 32, RuleTriggerDecl = 33, 
    RuleThisDecl = 34, RulePortDecl = 35, RuleNameDecl = 36, RuleIdPath = 37, 
    RuleStatementDecl = 38, RuleStatementBody = 39, RuleFunctionCallStatement = 40, 
    RuleNestedStatementBody = 41, RuleReturnStatement = 42, RuleBreakStatement = 43, 
    RuleOperation = 44, RuleOperationOptional = 45, RuleExpression = 46, 
    RuleExpressionOptional = 47, RuleConditionalStatement = 48, RuleIfStatement = 49, 
    RuleIfEuT = 50, RuleElseStatement = 51, RuleSwitchStatement = 52, RuleSwitchPuT = 53, 
    RuleCaseStatement = 54, RuleDefaultStatement = 55, RuleAtom = 56
  };

  ImportReaderParser(antlr4::TokenStream *input);
  ~ImportReaderParser();
  ...
  class  ImportReaderContext : public antlr4::ParserRuleContext {
  public:
    ImportReaderContext(antlr4::ParserRuleContext *parent, size_t invokingState);
  ...
  ImportReaderContext* importReader();
