...
class  TrafficSimDeclParser : public antlr4::Parser {
public:
  enum {
  ...
  enum {
    RuleStart = 0, RuleStartArm = 1, RuleEnd = 2, RuleStep = 3, RuleStepBody = 4, 
    RuleIntersection = 5, RuleIntersectionBody = 6, RuleTrafficLights = 7, 
    RuleTrafficLightsBody = 8, RuleTrafficSimulation = 9, RuleTrafficSimulationBodyP1 = 10, 
    RuleTrafficSimulationBodyP2 = 11, RuleVehicleMovement = 12, RuleVehicleMovementBody = 13, 
    RuleVehicleDistributionName = 14, RuleVehicleDistribution = 15, RuleVehicleDistributionBody = 16, 
    RuleSensor = 17, RuleSensorBody = 18, RuleLanes = 19, RuleOuterCon = 20, 
    RuleStringlist = 21, RuleStringlistBody = 22, RuleInnerCon = 23, RuleStates = 24, 
    RuleEdge = 25, RuleEdgeBody = 26, RulePhase = 27, RulePhaseBody = 28, 
    RuleTransitions = 29, RuleTransitionsBody = 30, RuleTransition = 31, 
    RuleTransitionBody = 32, RulePhases = 33, RulePhasesBody = 34, RuleTrafficLight = 35, 
    RuleTrafficLightBody = 36, RuleObject = 37, RuleComponentIdPath = 38, 
    RuleSignalIdPath = 39, RuleAttributeIdPath = 40, RuleSignalSend = 41, 
    RuleCommonDecl = 42, RuleImportPathDecl = 43, RuleImportPathBody = 44, 
    RuleImportFileBody = 45, RuleImportAs = 46, RuleTypeDefDecl = 47, RuleTypeDecl = 48, 
    RuleIntTypeDecl = 49, RuleRealTypeDecl = 50, RuleEnumTypeDecl = 51, 
    RuleAttributeDecl = 52, RuleLiteralValue = 53, RuleSignalParamName = 54, 
    RuleAttributeName = 55, RuleToPortName = 56, RuleAttributeAssignStatement = 57, 
    RuleLocalAssignStatement = 58, RuleSendToStatement = 59, RuleSingleAssignment = 60, 
    RuleMultiAssignment = 61, RuleSignalDecl = 62, RuleParamDecl = 63, RuleFunctionDecl = 64, 
    RuleFunctionParameters = 65, RuleFunctionCall = 66, RuleFunctionCallBody = 67, 
    RuleFunctionCallBodyOptional = 68, RuleContextID = 69, RuleTriggerDecl = 70, 
    RuleThisDecl = 71, RulePortDecl = 72, RuleNameDecl = 73, RuleIdPath = 74, 
    RuleStatementDecl = 75, RuleStatementBody = 76, RuleFunctionCallStatement = 77, 
    RuleNestedStatementBody = 78, RuleReturnStatement = 79, RuleBreakStatement = 80, 
    RuleOperation = 81, RuleOperationOptional = 82, RuleExpression = 83, 
    RuleExpressionOptional = 84, RuleConditionalStatement = 85, RuleIfStatement = 86, 
    RuleIfEuT = 87, RuleElseStatement = 88, RuleSwitchStatement = 89, RuleSwitchPuT = 90, 
    RuleCaseStatement = 91, RuleDefaultStatement = 92, RuleAtom = 93
  };

  TrafficSimDeclParser(antlr4::TokenStream *input);
  ~TrafficSimDeclParser();
  ...
  class StartContext;
  class StartArmContext;
  class EndContext;
  class StepContext;
  class StepBodyContext;
  class IntersectionContext;
  class IntersectionBodyContext;
  class TrafficLightsContext;
  class TrafficLightsBodyContext;
  class TrafficSimulationContext;
  class TrafficSimulationBodyP1Context;
  class TrafficSimulationBodyP2Context;
  class VehicleMovementContext;
  class VehicleMovementBodyContext;
  class VehicleDistributionNameContext;
  class VehicleDistributionContext;
  class VehicleDistributionBodyContext;
  class SensorContext;
  class SensorBodyContext;
  class LanesContext;
  class OuterConContext;
  class StringlistContext;
  class StringlistBodyContext;
  class InnerConContext;
  class StatesContext;
  class EdgeContext;
  class EdgeBodyContext;
  class PhaseContext;
  class PhaseBodyContext;
  class TransitionsContext;
  class TransitionsBodyContext;
  class TransitionContext;
  class TransitionBodyContext;
  class PhasesContext;
  class PhasesBodyContext;
  class TrafficLightContext;
  class TrafficLightBodyContext;
  class ObjectContext;
  ...
  public:
    antlr4::Token *startNumber = nullptr;;
  ...
  class  StartArmContext : public antlr4::ParserRuleContext {
  public:
    antlr4::Token *n = nullptr;;
    StartArmContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *StartArm();
    antlr4::tree::TerminalNode *COLON();
    antlr4::tree::TerminalNode *SEMI();
  ...
  StartArmContext* startArm();

  class  EndContext : public antlr4::ParserRuleContext {
  public:
    antlr4::Token *endNumber = nullptr;;
  ...
  class  StepBodyContext : public antlr4::ParserRuleContext {
  public:
    StepBodyContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    StartContext *start();
    StepBodyContext *stepBody();
    VehicleMovementContext *vehicleMovement();
    EndContext *end();
  ...
  class  IntersectionContext : public antlr4::ParserRuleContext {
  public:
    IntersectionContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *Intersection();
    antlr4::tree::TerminalNode *LBRACE();
    IntersectionBodyContext *intersectionBody();
    antlr4::tree::TerminalNode *RBRACE();
  ...
  class  IntersectionBodyContext : public antlr4::ParserRuleContext {
  public:
    antlr4::Token *n = nullptr;;
    antlr4::Token *l = nullptr;;
    antlr4::Token *hasTrafficLight = nullptr;;
    antlr4::Token *accident = nullptr;;
    IntersectionBodyContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    EdgeContext *edge();
    IntersectionBodyContext *intersectionBody();
    ...
    antlr4::tree::TerminalNode *HasTrafficLight();
    antlr4::tree::TerminalNode *Accident();
    antlr4::tree::TerminalNode *NeighboringTrafficLights();
    TrafficLightsContext *trafficLights();
  ...
  class  TrafficLightsContext : public antlr4::ParserRuleContext {
  public:
    TrafficLightsContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *COLON();
    antlr4::tree::TerminalNode *LBRACKET();
    antlr4::tree::TerminalNode *RBRACKET();
    TrafficLightContext *trafficLight();
    TrafficLightsBodyContext *trafficLightsBody();
  ...
  class  TrafficLightsBodyContext : public antlr4::ParserRuleContext {
  public:
    TrafficLightsBodyContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class  TrafficSimulationContext : public antlr4::ParserRuleContext {
  public:
    TrafficSimulationContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *TRAFFICSIMULATION();
    antlr4::tree::TerminalNode *LBRACE();
    TrafficSimulationBodyP1Context *trafficSimulationBodyP1();
    TrafficSimulationBodyP2Context *trafficSimulationBodyP2();
    antlr4::tree::TerminalNode *RBRACE();
  ...
  TrafficSimulationContext* trafficSimulation();

  class  TrafficSimulationBodyP1Context : public antlr4::ParserRuleContext {
  public:
    TrafficSimulationBodyP1Context(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    IntersectionContext *intersection();
    TrafficSimulationBodyP1Context *trafficSimulationBodyP1();
  ...
  class  TrafficSimulationBodyP2Context : public antlr4::ParserRuleContext {
  public:
    TrafficSimulationBodyP2Context(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    StepContext *step();
    TrafficSimulationBodyP2Context *trafficSimulationBodyP2();
  ...
  class  VehicleMovementContext : public antlr4::ParserRuleContext {
  public:
    VehicleMovementContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *VehicleMovement();
    antlr4::tree::TerminalNode *LBRACE();
    VehicleMovementBodyContext *vehicleMovementBody();
    antlr4::tree::TerminalNode *RBRACE();
  ...
  class  VehicleMovementBodyContext : public antlr4::ParserRuleContext {
  public:
    antlr4::Token *vehiclePerHour = nullptr;;
    VehicleMovementBodyContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    StartArmContext *startArm();
    VehicleMovementBodyContext *vehicleMovementBody();
    antlr4::tree::TerminalNode *VehiclePerHour();
    antlr4::tree::TerminalNode *COLON();
    antlr4::tree::TerminalNode *SEMI();
    VehicleDistributionNameContext *vehicleDistributionName();
    antlr4::tree::TerminalNode *REAL();
  ...
  class  VehicleDistributionNameContext : public antlr4::ParserRuleContext {
  public:
    antlr4::Token *vehDist = nullptr;;
    VehicleDistributionNameContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *VehicleDistribution();
    antlr4::tree::TerminalNode *COLON();
    antlr4::tree::TerminalNode *SEMI();
    antlr4::tree::TerminalNode *STRING();
  ...
  class  VehicleDistributionContext : public antlr4::ParserRuleContext {
  public:
    VehicleDistributionContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *LVehicleDistribution();
    antlr4::tree::TerminalNode *LBRACE();
    VehicleDistributionBodyContext *vehicleDistributionBody();
    antlr4::tree::TerminalNode *RBRACE();
  ...
  VehicleDistributionContext* vehicleDistribution();

  class  VehicleDistributionBodyContext : public antlr4::ParserRuleContext {
  public:
    antlr4::Token *n = nullptr;;
    antlr4::Token *bicycle = nullptr;;
    antlr4::Token *bus = nullptr;;
    antlr4::Token *moped = nullptr;;
    antlr4::Token *motorcyc = nullptr;;
    antlr4::Token *car = nullptr;;
    antlr4::Token *emerg = nullptr;;
    antlr4::Token *truck = nullptr;;
    VehicleDistributionBodyContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *NameID();
    antlr4::tree::TerminalNode *COLON();
    antlr4::tree::TerminalNode *SEMI();
    VehicleDistributionBodyContext *vehicleDistributionBody();
    antlr4::tree::TerminalNode *Bicycle();
    antlr4::tree::TerminalNode *Bus();
    antlr4::tree::TerminalNode *Moped();
    antlr4::tree::TerminalNode *Motorcycle();
    antlr4::tree::TerminalNode *Car();
    antlr4::tree::TerminalNode *Emergency();
    antlr4::tree::TerminalNode *Truck();
    antlr4::tree::TerminalNode *ID();
    antlr4::tree::TerminalNode *REAL();
  ...
  class  SensorContext : public antlr4::ParserRuleContext {
  public:
    SensorContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *Sensor();
    antlr4::tree::TerminalNode *LBRACE();
    SensorBodyContext *sensorBody();
    antlr4::tree::TerminalNode *RBRACE();
  ...
  class  SensorBodyContext : public antlr4::ParserRuleContext {
  public:
    antlr4::Token *n = nullptr;;
    antlr4::Token *t = nullptr;;
    antlr4::Token *mArm = nullptr;;
    antlr4::Token *mLane = nullptr;;
    antlr4::Token *mes = nullptr;;
    SensorBodyContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *NameID();
    antlr4::tree::TerminalNode *COLON();
    antlr4::tree::TerminalNode *SEMI();
    ...
    antlr4::tree::TerminalNode *Measured();
    antlr4::tree::TerminalNode *Arm();
    antlr4::tree::TerminalNode *Lane();
  ...
  class  LanesContext : public antlr4::ParserRuleContext {
  public:
    antlr4::Token *streetlanes = nullptr;;
    LanesContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *Lanes();
    antlr4::tree::TerminalNode *COLON();
    antlr4::tree::TerminalNode *STRING();
  ...
  class  OuterConContext : public antlr4::ParserRuleContext {
  public:
    antlr4::Token *outer = nullptr;;
    OuterConContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *OuterConnection();
    antlr4::tree::TerminalNode *COLON();
    antlr4::tree::TerminalNode *STRING();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *RBRACKET();
    antlr4::tree::TerminalNode *STRING();
    StringlistBodyContext *stringlistBody();
  ...
  class  StringlistBodyContext : public antlr4::ParserRuleContext {
  public:
    StringlistBodyContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *COMMA();
    antlr4::tree::TerminalNode *STRING();
    StringlistBodyContext *stringlistBody();
  ...
  class  InnerConContext : public antlr4::ParserRuleContext {
  public:
    InnerConContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *InnerConnections();
    StringlistContext *stringlist();
  ...
  InnerConContext* innerCon();

  class  StatesContext : public antlr4::ParserRuleContext {
  public:
    StatesContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class  EdgeBodyContext : public antlr4::ParserRuleContext {
  public:
    antlr4::Token *n = nullptr;;
    EdgeBodyContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *NameID();
    antlr4::tree::TerminalNode *COLON();
    antlr4::tree::TerminalNode *SEMI();
  ...
  class  PhaseBodyContext : public antlr4::ParserRuleContext {
  public:
    antlr4::Token *dur = nullptr;;
    antlr4::Token *minDur = nullptr;;
    antlr4::Token *maxDur = nullptr;;
    antlr4::Token *name = nullptr;;
    antlr4::Token *factor = nullptr;;
    PhaseBodyContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *Duration();
    antlr4::tree::TerminalNode *COLON();
    antlr4::tree::TerminalNode *SEMI();
    PhaseBodyContext *phaseBody();
    antlr4::tree::TerminalNode *MinDur();
    antlr4::tree::TerminalNode *MaxDur();
    antlr4::tree::TerminalNode *NameID();
    EdgeContext *edge();
  ...
  public:
    ...
    TransitionsBodyContext *transitionsBody();
  ...
  class  TransitionsBodyContext : public antlr4::ParserRuleContext {
  public:
    TransitionsBodyContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *COMMA();
    TransitionContext *transition();
    TransitionsBodyContext *transitionsBody();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *LBRACE();
    TransitionBodyContext *transitionBody();
    antlr4::tree::TerminalNode *RBRACE();
  ...
  class  TransitionBodyContext : public antlr4::ParserRuleContext {
  public:
    TrafficSimDeclParser::PhaseContext *startPhase = nullptr;;
    TrafficSimDeclParser::PhaseContext *endPhase = nullptr;;
    TransitionBodyContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *TransitionPhases();
    PhasesContext *phases();
    antlr4::tree::TerminalNode *SEMI();
    TransitionBodyContext *transitionBody();
  ...
  class  PhasesContext : public antlr4::ParserRuleContext {
  public:
    PhasesContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *COLON();
    antlr4::tree::TerminalNode *LBRACKET();
    antlr4::tree::TerminalNode *RBRACKET();
    PhaseContext *phase();
    PhasesBodyContext *phasesBody();
  ...
  class  PhasesBodyContext : public antlr4::ParserRuleContext {
  public:
    PhasesBodyContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *COMMA();
    PhaseContext *phase();
    PhasesBodyContext *phasesBody();
  ...
  class  TrafficLightContext : public antlr4::ParserRuleContext {
  public:
    TrafficLightContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *TrafficLight();
    antlr4::tree::TerminalNode *LBRACE();
    TrafficLightBodyContext *trafficLightBody();
    antlr4::tree::TerminalNode *RBRACE();
  ...
  class  TrafficLightBodyContext : public antlr4::ParserRuleContext {
  public:
    antlr4::Token *name = nullptr;;
    antlr4::Token *type = nullptr;;
    antlr4::Token *dur = nullptr;;
    antlr4::Token *turns = nullptr;;
    TrafficLightBodyContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *Transitions();
    TransitionsContext *transitions();
    antlr4::tree::TerminalNode *SEMI();
    TrafficLightBodyContext *trafficLightBody();
    antlr4::tree::TerminalNode *NameID();
    ...
    antlr4::tree::TerminalNode *TypeID();
    antlr4::tree::TerminalNode *Duration();
    antlr4::tree::TerminalNode *Turns();
    antlr4::tree::TerminalNode *Phases();
    PhasesContext *phases();
    antlr4::tree::TerminalNode *ID();
    antlr4::tree::TerminalNode *STRING();
    antlr4::tree::TerminalNode *INT();
