...
class DSLPARSERSHARED_EXPORT ComBuildSpenatModel
    : public QObject
{
public:
  ComBuildSpenatModel(const QString& spenatDocText,
                      model::spenat::SpenatDeclModel* spenatDeclModel,
                      bool strictErrorHandling = true,
                      QObject* parent =0);
  virtual ~ComBuildSpenatModel();
...
private:
  Q_DISABLE_COPY(ComBuildSpenatModel)
  class Private;
  Private* _d;
};
