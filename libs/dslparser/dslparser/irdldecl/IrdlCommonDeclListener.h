...
public:
  ...
  virtual void enterAttributeAssign(IrdlCommonDeclParser::AttributeAssignContext *ctx) = 0;
  virtual void exitAttributeAssign(IrdlCommonDeclParser::AttributeAssignContext *ctx) = 0;
