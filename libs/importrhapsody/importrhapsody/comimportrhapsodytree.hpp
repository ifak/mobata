...
class ComImportRhapsodyTree
    : protected ImportRhapsodyProp
{
public:
  ComImportRhapsodyTree(RhapsodyPointer* rhapsodyPointer,
                        QStandardItemModel *standardItemModel,
                        const QString &projectFilePath);
  virtual ~ComImportRhapsodyTree();

public:
  bool execute(QString* errorMessage = 0);

private:
  Q_DISABLE_COPY(ComImportRhapsodyTree)
  class Private;
  Private* _d;
};
