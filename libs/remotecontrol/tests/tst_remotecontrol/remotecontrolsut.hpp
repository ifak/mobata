...
#include <remotecontrol/remotecontrolservice.hpp>

class RemoteControlSutService
    : public remotecontrol::RemoteControlService
{};

class RemoteControlSut
    : public remotecontrol::RemoteControl
{
public:
  RemoteControlSut(const QString& name,
                   RemoteControlSutService* remoteControlSutService,
                   QObject* parent = nullptr);
  virtual ~RemoteControlSut();
};
