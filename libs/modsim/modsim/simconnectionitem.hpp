...
public:
  ...
  void setTargetModel(const QString& targetModelAsName);
  void setTargetPort(const QString& targetPortName);
  void setSourceModel(const QString& sourceModelAsName);
  void setSourcePort(const QString& sourcePortName);
